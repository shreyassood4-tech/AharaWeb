...
import PhaseUnlockAnimation from "@/components/PhaseUnlockAnimation";
    ...
    <>
      ...
      <section className="bg-abyss py-16 md:py-[120px]">
        <div className="max-w-4xl mx-auto px-6 flex flex-col gap-8">
          <ScrollReveal>
            <p className="font-mono text-forest text-xs tracking-[0.2em] uppercase mb-4">THE REAL PROBLEM</p>
            <h2 className="font-cormorant font-semibold text-charcoal leading-tight max-w-[680px]" style={{ fontSize: "clamp(32px, 4vw, 52px)" }}>
              Getting a vitamin into a powder is easy. Getting it into your body is where most supplements fail.
            </h2>
          </ScrollReveal>
          <ScrollReveal delay={0.15}>
            <p className="font-inter leading-relaxed max-w-[640px]" style={{ color: "rgba(26,26,26,0.80)", fontSize: "18px" }}>
      ...
      <section className="bg-abyss pb-16 md:pb-[120px]">
        <div className="max-w-5xl mx-auto px-6 flex flex-col gap-8">
          <ScrollReveal className="text-center">
            ...
            <h3 className="font-cormorant font-light text-charcoal leading-tight mx-auto max-w-[640px]" style={{ fontSize: "clamp(28px, 4vw, 44px)" }}>
              Same vitamins. A different fate inside your body.
            </h3>
            <p className="font-inter mt-4 max-w-[560px] mx-auto" style={{ color: "rgba(26,26,26,0.65)", fontSize: "16px", lineHeight: 1.7 }}>
      ...
      <section className="bg-void py-16 md:py-[120px]">
        <div className="max-w-5xl mx-auto px-6 flex flex-col items-center gap-12">
          <ScrollReveal className="text-center">
            <p className="font-mono text-forest text-xs tracking-[0.2em] uppercase mb-4">HOW WE FORMULATE</p>
            <h2 className="font-cormorant font-light text-charcoal leading-tight" style={{ fontSize: "clamp(32px, 4vw, 56px)" }}>
              A formula built in layers.<br />Each layer earns its place.
            </h2>
            <p className="font-inter mt-4 max-w-[540px] mx-auto" style={{ color: "rgba(26,26,26,0.68)", fontSize: "17px", lineHeight: 1.7 }}>
          ...
          {[
            ...
            <ScrollReveal key={i} delay={i * 0.1} className="w-full">
              <div className="glass-card p-8 md:p-10 flex flex-col md:flex-row gap-8 md:gap-10 md:items-center">
                <div className="md:flex-[3] flex flex-col gap-4">
                  <p className="font-mono text-gold text-[11px] tracking-[0.2em]">{card.phase}</p>
                  <h3 className="font-cormorant font-semibold text-charcoal text-2xl">{card.title}</h3>
                  <p className="font-inter leading-relaxed" style={{ color: "rgba(26,26,26,0.78)", fontSize: "16px" }}>
                    {card.body}
                  </p>
                ...
                <div className="md:flex-[2] w-full">
                  <PhaseUnlockAnimation phase={(i + 1) as 1 | 2 | 3 | 4} />
                </div>
              </div>
            </ScrollReveal>
          ))}
      ...
      <section className="bg-abyss py-16 md:py-[120px]">
        <div className="max-w-4xl mx-auto px-6">
          <ScrollReveal>
            <p className="font-mono text-forest text-xs tracking-[0.2em] uppercase mb-12">THE ACTIVES</p>
          </ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <ScrollReveal className="flex flex-col gap-6 pr-0 md:pr-12 py-8">
              ...
              <p className="font-inter text-center leading-relaxed" style={{ color: "rgba(26,26,26,0.78)", fontSize: "16px" }}>
