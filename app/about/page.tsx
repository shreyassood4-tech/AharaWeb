      ...
      <section className="bg-abyss py-16 md:py-[120px]">
        <div className="max-w-5xl mx-auto px-6 flex flex-col gap-12">
          <ScrollReveal>
            ...
            <h2 className="font-cormorant font-semibold text-white" style={{ fontSize: "clamp(32px, 4vw, 48px)" }}>
              Science meets strategy.
            </h2>
            <p className="font-inter mt-4 max-w-[580px]" style={{ color: "rgba(242,237,227,0.72)", fontSize: "18px", lineHeight: 1.75 }}>
          ...
          <ScrollReveal stagger className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <RevealItem>
              <div className="glass-card p-8 flex flex-col gap-6">
                <div className="w-[72px] h-[72px] rounded-full bg-gold flex items-center justify-center">
                  <span className="font-cormorant text-white text-2xl font-semibold">SS</span>
                </div>
                <div>
                  <h3 className="font-cormorant text-white text-2xl font-semibold">Shreyas Sood</h3>
            ...
            <RevealItem>
              <div className="glass-card p-8 flex flex-col gap-6">
                ...
                <div>
                  <h3 className="font-cormorant text-white text-2xl font-semibold">Meagan Ghai</h3>
            ...
            <RevealItem>
              <div className="glass-card p-8 flex flex-col gap-6">
                <div className="w-[72px] h-[72px] rounded-full flex items-center justify-center" style={{ background: "#1a3a2a" }}>
                  <span className="font-cormorant text-gold text-2xl font-semibold">KB</span>
                </div>
                <div>
                  <h3 className="font-cormorant text-white text-2xl font-semibold">Krish Barot</h3>
                  <p className="font-mono text-gold text-[11px] tracking-[0.2em] mt-1">HEAD OF MARKETING</p>
                </div>
                <div className="flex flex-wrap gap-2">
                  {["MARKETING", "CONTENT", "SOCIAL MEDIA", "GROWTH"].map((tag) => (
                    <span key={tag} className="font-mono text-gold text-[10px] tracking-wider px-3 py-1 rounded-full border border-gold/40">
                      {tag}
                    </span>
                  ))}
      ...
      <section className="bg-abyss py-16 md:py-[120px]">
        <div className="max-w-4xl mx-auto px-6 flex flex-col items-center gap-10 text-center">
          ...
          <ScrollReveal delay={0.1}>
            <p className="font-inter max-w-[560px] leading-relaxed" style={{ color: "rgba(242,237,227,0.72)", fontSize: "18px" }}>
          ...
          <ScrollReveal delay={0.2}>
            <p className="font-inter text-center" style={{ color: "rgba(242,237,227,0.65)", fontSize: "16px" }}>
